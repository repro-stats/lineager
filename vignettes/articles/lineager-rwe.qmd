...
author: "Ndoh Penn"
date: "2026-06-26"
categories: [lineager, RWE, cohort-derivation, exclusion-tracking, data-provenance, HEOR]
format:
  html:
    toc: true
    toc-depth: 3
...
claims_raw <- data.frame(
  ...
  INDEX_DRUG = sample(c("GLP1RA", "DPP4i"), n_pool,
    replace = TRUE,
    prob = c(0.42, 0.58)
  ),
...
lg_population(
  ...
  incl_criteria = c(
    "Age 40-89", "T2DM confirmed", ">=12mo lookback",
